    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b border-gray-200 px-4 py-4 sticky top-0 z-10">
        <div className="max-w-2xl mx-auto flex items-center justify-between">
          <h1 className="text-xl font-bold text-gray-900">Controle de Contas</h1>
          <button
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          {loading ? (
            ...
            <div className="py-16 text-center">
              <p className="text-gray-400 text-sm">Nenhuma transação em {MONTHS[currentDate.getMonth()]}.</p>
              <button
                onClick={() => setShowModal(true)}
        ...
        >
          <div className="bg-white rounded-2xl w-full max-w-md p-6 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => setShowModal(false)} className="text-gray-400 hover:text-gray-600 text-2xl leading-none w-8 h-8 flex items-center justify-center">
                ×
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div className="grid grid-cols-2 gap-2">
                <button
                  type="button"
                  onClick={() => setForm(f => ({ ...f, type: 'expense', category: 'Outros' }))}
                ...
                <button
                  type="button"
                  onClick={() => setForm(f => ({ ...f, type: 'income', category: 'Outros' }))}
